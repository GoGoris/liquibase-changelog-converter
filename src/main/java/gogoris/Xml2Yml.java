...
public class Xml2Yml {
    public static void main(String[] args) throws LiquibaseException, IOException {
        ...
        ChangeLogSerializer serializer = ChangeLogSerializerFactory.getInstance().getSerializer("yml");
        String outputFilename = getBasepath(inputFilename) + ".yml";
